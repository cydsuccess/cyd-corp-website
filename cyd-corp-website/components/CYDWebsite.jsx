...
const PrimaryButton = ({ children }) => (
  <a
    href="#contact"
    className="inline-flex items-center rounded-2xl bg-cyan-500/90 px-5 py-3 text-sm font-semibold tracking-wide text-black shadow-lg transition hover:translate-y-[-1px] hover:bg-cyan-400 focus:outline-none focus:ring-2 focus:ring-cyan-300"
  >
    {children}
  </a>
);
    ...
    <div className="min-h-screen scroll-smooth bg-neutral-950 text-neutral-100 antialiased">
      ...
      <header className="sticky top-0 z-50 border-b border-white/5 bg-neutral-950/70 backdrop-blur">
        <Container className="flex h-16 items-center justify-between">
          <div className="flex items-center gap-3">
            {/* Symbol-only logo placeholder: swap src with your SVG/PNG */}
            <div className="grid h-9 w-9 place-items-center rounded-xl bg-white text-neutral-900 shadow-inner shadow-cyan-400/40">
              <span className="font-black">CYD</span>
            </div>
      ...
      <section id="hero" className="relative overflow-hidden">
        ...
        <Container className="relative grid gap-10 py-20 lg:grid-cols-2 lg:gap-16 lg:py-28">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            {/* Full-text logo placeholder */}
            <div className="mb-6 inline-flex items-center gap-4">
              <div className="grid h-12 w-12 place-items-center rounded-2xl border border-cyan-400/30 bg-white/5 text-xs tracking-widest text-cyan-200">
                <span className="font-extrabold">CYD</span>
              </div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <PrimaryButton>Get a free audit</PrimaryButton>
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <form className="mt-8 grid gap-4 text-left">
              ...
              <div className="flex items-center justify-center gap-3">
                ...
                <SecondaryButton href="#hero">Back to top</SecondaryButton>
              </div>
            </form>
          </div>
        </Container>
      ...
      <footer className="border-t border-white/5 py-10">
        <Container className="flex flex-col items-center justify-between gap-6 text-sm text-neutral-400 md:flex-row">
          <div className="flex items-center gap-3">
            <div className="grid h-8 w-8 place-items-center rounded-lg bg-white text-neutral-900">
              <span className="text-[10px] font-black">CYD</span>
            </div>
